...
import com.example.myapplication.CardStackAdapter
...
class SwipePlayFragment : Fragment(), CardStackListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.swipe_play_fragment, container, false)
    ...
    private fun setupNavigation() {
        ...
        // DrawerLayout
        val actionBarDrawerToggle = ActionBarDrawerToggle(requireActivity(), drawerLayout, toolbar, R.string.open_drawer, R.string.close_drawer)
